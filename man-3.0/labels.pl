...
$key = q/cite_G;SPMamp;K/;
$external_labels{$key} = "$URL/" . q|node138.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_P;SPMamp;R/;
$external_labels{$key} = "$URL/" . q|node138.html|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_H;SPMamp;P/;
$external_labels{$key} = "$URL/" . q|node138.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_K;SPMamp;R/;
$external_labels{$key} = "$URL/" . q|node138.html|; 
$noresave{$key} = "$nosave";
...
$key = q/debugging/;
$external_latex_labels{$key} = q|8.12.4|; 
$noresave{$key} = "$nosave";
...
$key = q/IGD/;
$external_latex_labels{$key} = q|8.12.5|; 
$noresave{$key} = "$nosave";
