...
void sym_close_environment(problem *p){
...
{
   problem *p;
   int s_bufid, r_bufid, bytes, msgtag = 0, sender, termcode, tid = 0;
   ...
   tid = register_process();   /* Enroll this process */
