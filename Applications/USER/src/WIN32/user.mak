...
ALL : "$(OUTDIR)" "APPL_MESSAGE" user.lib "SYMPHONY_MESSAGE" "OBJECTS" symphony.exe 

CLEAN:
	del /Q $(OUTDIR)\*.obj
        del /Q $(OUTDIR)\symphony.exe 
        del /Q $(OUTDIR)\user.lib
        del /Q $(OUTDIR)\user.idb
        del /Q $(OUTDIR)\user.pdb
	del /Q $(OUTDIR)\user.pch
...
user.lib : \
	...
	lib.exe /nologo /out:$(OUTDIR)\user.lib $(OUTDIR)\*.obj
...
symphony.exe : $(LINK_OBJS) $(OUTDIR)\user.lib
	echo Linking...
