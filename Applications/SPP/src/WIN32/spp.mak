...
ALL : "$(OUTDIR)" "APPL_MESSAGE" spp.lib "SYMPHONY_MESSAGE" "OBJECTS" symphony.exe 

CLEAN:
	del /Q $(OUTDIR)\*.obj
        del /Q $(OUTDIR)\symphony.exe 
        del /Q $(OUTDIR)\spp.lib
...
spp.lib : \
	...
	lib.exe /nologo /out:$(OUTDIR)\spp.lib $(OUTDIR)\*.obj
...
symphony.exe : $(LINK_OBJS) $(OUTDIR)\spp.lib
	echo Linking...
