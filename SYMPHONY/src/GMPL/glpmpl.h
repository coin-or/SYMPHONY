...
#define O_ROUND         329   /* round to nearest integer */
#define O_TRUNC         330   /* truncate to nearest integer */
                              /* binary operations -------------------*/
#define O_ADD           331   /* addition */
#define O_SUB           332   /* subtraction */
#define O_LESS          333   /* non-negative subtraction */
#define O_MUL           334   /* multiplication */
#define O_DIV           335   /* division */
#define O_IDIV          336   /* quotient of exact division */
#define O_MOD           337   /* remainder of exact division */
#define O_POWER         338   /* exponentiation (raise to power) */
#define O_ROUND2        339   /* round to n fractional digits */
#define O_TRUNC2        340   /* truncate to n fractional digits */
#define O_UNIFORM       341   /* pseudo-random in [a, b) */
#define O_NORMAL        342   /* gaussian random, given mu and sigma */
#define O_CONCAT        343   /* concatenation */
#define O_LT            344   /* comparison on 'less than' */
#define O_LE            345   /* comparison on 'not greater than' */
#define O_EQ            346   /* comparison on 'equal to' */
#define O_GE            347   /* comparison on 'not less than' */
#define O_GT            348   /* comparison on 'greater than' */
#define O_NE            349   /* comparison on 'not equal to' */
#define O_AND           350   /* conjunction (logical "and") */
#define O_OR            351   /* disjunction (logical "or") */
#define O_UNION         352   /* union */
#define O_DIFF          353   /* difference */
#define O_SYMDIFF       354   /* symmetric difference */
#define O_INTER         355   /* intersection */
#define O_CROSS         356   /* cross (Cartesian) product */
#define O_IN            357   /* test on 'x in Y' */
#define O_NOTIN         358   /* test on 'x not in Y' */
#define O_WITHIN        359   /* test on 'X within Y' */
#define O_NOTWITHIN     360   /* test on 'X not within Y' */
                              /* ternary operations ------------------*/
#define O_DOTS          361   /* build "arithmetic" set */
#define O_FORK          362   /* if-then-else */
                              /* n-ary operations --------------------*/
#define O_MIN           363   /* minimal value (n-ary) */
#define O_MAX           364   /* maximal value (n-ary) */
                              /* iterated operations -----------------*/
#define O_SUM           365   /* summation */
#define O_PROD          366   /* multiplication */
#define O_MINIMUM       367   /* minimum */
#define O_MAXIMUM       368   /* maximum */
#define O_FORALL        369   /* conjunction (A-quantification) */
#define O_EXISTS        370   /* disjunction (E-quantification) */
#define O_SETOF         371   /* compute elemental set */
#define O_BUILD         372   /* build elemental set */
      OPERANDS arg;
