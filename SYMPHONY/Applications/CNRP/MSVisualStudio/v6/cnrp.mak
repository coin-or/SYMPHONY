...
# optimization solver via COIN_OSI's CLP interface and CGL cuts. 
...
DEFINITIONS = $(DEFINITIONS) /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" \
	...
	/D "COMPILE_IN_TM" /D "USE_SYM_APPLICATION" /D "MULTI_CRITERIA" \
	/D "DIRECTED_X_VARS" /D "ADD_FLOW_VARS" /D "SAVE_CUT_POOL"
...
CPPFLAGS= /nologo /MLd /W2 /GR /Gm /YX /GX /ZI /Od \
	...
	/Fp"$(OUTDIR)\cnrp.pch" /Fo"$(OUTDIR)\\" /Fd"$(OUTDIR)\cnrp.pdb" \
	/FD /GZ /c /Tp
...
ALL : "$(OUTDIR)" "LIB_MESSAGE" sym_lib "APPL_MESSAGE" "APPL_OBJECTS" cnrp_exe 

CLEAN:
	del /Q $(OUTDIR)\*.obj
        del /Q $(OUTDIR)\cnrp.exe 
        del /Q $(OUTDIR)\symphonyLib.lib
        del /Q $(OUTDIR)\cnrp.idb
        del /Q $(OUTDIR)\cnrp.pdb
	del /Q $(OUTDIR)\cnrp.pch
...
APPL_OBJECTS : \
	..\..\src\Common\compute_cost.obj \
	..\..\src\Common\network.obj \
	..\..\src\Common\cnrp_macros.obj \
	..\..\src\CutGen\biconnected.obj \
	..\..\src\CutGen\shrink.obj \
	..\..\src\CutGen\cnrp_cg.obj \
	..\..\src\CutPool\cnrp_cp.obj \
	..\..\src\DrawGraph\cnrp_dg_functions.obj \
	..\..\src\LP\cnrp_lp.obj \
	..\..\src\LP\cnrp_lp_branch.obj \
	..\..\src\Master\small_graph.obj \
	..\..\src\Master\cnrp_io.obj \
	..\..\src\Master\cnrp_master.obj \
	..\..\src\Master\cnrp_master_functions.obj \
	..\..\src\Master\cnrp_main.obj
...
LINK_OBJECTS= \
	...
	$(OUTDIR)\network.obj \
	$(OUTDIR)\cnrp_macros.obj \
	$(OUTDIR)\biconnected.obj \
	$(OUTDIR)\shrink.obj \
	$(OUTDIR)\cnrp_cg.obj \
	$(OUTDIR)\cnrp_cp.obj \
	$(OUTDIR)\cnrp_dg_functions.obj \
	$(OUTDIR)\cnrp_lp.obj \
	$(OUTDIR)\cnrp_lp_branch.obj \
	$(OUTDIR)\small_graph.obj \
	$(OUTDIR)\cnrp_io.obj \
	$(OUTDIR)\cnrp_master.obj \
	$(OUTDIR)\cnrp_master_functions.obj \
	$(OUTDIR)\cnrp_main.obj \
...
cnrp_exe : $(LINK_OBJECTS) $(OUTDIR)\libSymphony.lib
	echo Linking...
	$(CPP) /nologo /W3 /Fe"$(OUTDIR)\cnrp.exe" $(ALL_LIB) $**
	echo "cnrp.exe" created successfully...
