...
functions begin with the prefix \ptt{user\_}. For instance, the
\ptt{user\_find\_cuts()} subroutine is used to implement subroutines for
...
\end{center}
There is also a Web site for \BB\ at 
\begin{center}
\url{https://projects.coin-or.org/SYMPHONY}
\end{center}
Bug reports can be submitted to and viewed from 
\begin{center}
\url{https://projects.coin-or.org/SYMPHONY/report}
\end{center}
