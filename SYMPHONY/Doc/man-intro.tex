...
The callable library has both C and C++ interfaces with a look and feel
...
must have installed the {\em \htmladdnormallink{Parallel Virtual
Machine}{http://www.ccs.ornl.gov/pvm/}} (PVM), available for free from Oak
...
``double-clicking'' on the \code{symphony.exe} file in Windows Explorer.
