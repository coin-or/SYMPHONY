...
SYMPHONY-3.0.1$\backslash$Makefile}, a Unix-style makefile included with the
...
SYMPHONY-3.0.1$\backslash$WIN32$\backslash$template.dsw} and modify for your local
