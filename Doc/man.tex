...
%begin{latexonly}
\renewcommand{\functiondef}[1]{\item[\Large $\triangleright$] {\bf
\Large #1}}
%end{latexonly}
...
\end{rawhtml}
\title{\huge {\bf \BB\ 3.0 User's Manual}
\thanks{This research was partially supported by NSF Grant
DMS-9527124, Texas ATP Grant 97-3604-010, and NSF Grant ACI-0102687}
%begin{latexonly}
\vskip 1.7in
\LARGE 
...
HREF="ftp://branchandcut.org/pub/reference/SYMPHONY-3.0-Manual.pdf">here</A>
</FONT></STRONG></P>
\end{rawhtml}
\begin{rawhtml} </P> </FONT> </STRONG> 
\end{rawhtml}
...
\end{rawhtml}
\begin{center}
{\copyright 2000, 2001, 2002 Ted Ralphs\footnote{A revised version of 
Sections 1-7 of this manual
...
\section{Developing Applications with \BB}
\label{development}
\input{man-SYMPHONY}
