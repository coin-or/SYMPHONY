...
data is contained (either an MPS file or an GMPL/AMPL file). The ``-D'' switch
is used to specify the data file if an GMPL/AMPL file is being read in (see
the README file).
...
{\tt char *obj_sense} & INOUT & Whether to negate the objective function value
...
{\tt double *obj_offset} & INOUT & A specified constant to be added to the
