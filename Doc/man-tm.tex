...
{\tt drawgraph} process. By default, SYMPHONY displays the indices and values
for each nonzero variable in the solution. The user may wish to display a
custom version of the solution by interpreting the variables. For instance,
the user could keep an array of names for each variable and then display the
