...
ALL : "$(OUTDIR)" "LIB_MESSAGE" sym_lib "APPL_MESSAGE" "APPL_OBJECTS" mpp_exe 

CLEAN:
	del /Q $(OUTDIR)\*.obj
	del /Q $(OUTDIR)\mpp.exe
...
APPL_OBJECTS : \
	..\..\src\CutGen\mpp_cg.obj \
	..\..\src\CutPool\mpp_cp.obj \
	..\..\src\DrawGraph\mpp_dg.obj \
	..\..\src\LP\mpp_lp.obj \
	..\..\src\LP\mpp_lp_branch.obj \
	..\..\src\Master\mpp_master.obj \
	..\..\src\Master\mpp_main.obj
...
LINK_OBJECTS= \
	...
	$(OUTDIR)\mpp_dg.obj \
	$(OUTDIR)\mpp_lp.obj \
	$(OUTDIR)\mpp_lp_branch.obj \
	$(OUTDIR)\mpp_master.obj \
	$(OUTDIR)\mpp_main.obj
...
mpp_exe : $(LINK_OBJECTS) $(OUTDIR)\libSymphony.lib
	echo Linking...
	$(CPP) /nologo /W3 /Fe"$(OUTDIR)\mpp.exe" $(ALL_LIB) $**
	echo "mpp.exe" created successfully...
