...
CPPFLAGS= /nologo /MLd /W2 /GR /Gm /YX /GX /ZI /Od \
	...
	/Fp"$(OUTDIR)\spp.pch" /Fo"$(OUTDIR)\\" /Fd"$(OUTDIR)\spp.pdb" \
	/FD /GZ /c /Tp

.c.obj: 
	$(CPP) $(CPPFLAGS) "$*.c"
	 
ALL : "$(OUTDIR)" "LIB_MESSAGE" sym_lib "APPL_MESSAGE" "APPL_OBJECTS" spp_exe 

CLEAN:
	del /Q $(OUTDIR)\*.obj
        del /Q $(OUTDIR)\spp.exe 
        del /Q $(OUTDIR)\symphonyLib.lib
        del /Q $(OUTDIR)\spp.idb
        del /Q $(OUTDIR)\spp.pdb
	del /Q $(OUTDIR)\spp.pch
...
APPL_OBJECTS : \
	..\..\src\Common\spp_common.obj \
	..\..\src\CutGen\spp_cg.obj \
	..\..\src\CutPool\spp_cp.obj \
	..\..\src\DrawGraph\spp_dg.obj \
	..\..\src\LP\spp_lp.obj \
	..\..\src\LP\spp_lp_branch.obj \
	..\..\src\Master\spp_master.obj \
	..\..\src\Master\spp_master_functions.obj \
	..\..\src\Master\spp_main.obj
...
spp_exe : $(LINK_OBJECTS) $(OUTDIR)\libSymphony.lib
	echo Linking...
	$(CPP) /nologo /W3 /Fe"$(OUTDIR)\spp.exe" $(ALL_LIB) $**
	echo "spp.exe" created successfully...
